...
public class MyFTPClientFunctions {
    ...
    public String[] ftpPrintFilesList(String dir_path) {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                Calendar cal = ftpFiles[i].getTimestamp();
                ...
                String name = ftpFiles[i].getName() + "~" + formattedDate;
    ...
    public String[] ftpPrintDirectoryList() {
        String[] fileList = null;
        try {
    ...
    public boolean ftpUploadProfile(String srcFilePath, String desFileName,
                                    String desDirectory, Context context) {
        boolean status = false;
        try {
            FileInputStream srcFileStream = new FileInputStream(srcFilePath);
